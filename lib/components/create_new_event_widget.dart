...
class CreateNewEventWidget extends StatefulWidget {
  const CreateNewEventWidget({Key? key}) : super(key: key);

  @override
  _CreateNewEventWidgetState createState() => _CreateNewEventWidgetState();
}
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            focusedBorder: OutlineInputBorder(
                              borderSide: BorderSide(
                                color:
                                    FlutterFlowTheme.of(context).celestialBlue,
                                width: 2.0,
                              ),
                              borderRadius: BorderRadius.circular(8.0),
                            ),
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: FlutterFlowTheme.of(context).celestialBlue,
                              width: 2.0,
                            ),
                            borderRadius: BorderRadius.circular(8.0),
                          ),
                ...
                child: Row(
                  ...
                  children: [
                    FlutterFlowRadioButton(
                      ...
                      radioButtonColor: FlutterFlowTheme.of(context).celeste,

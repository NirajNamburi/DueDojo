...
class _EmptyTodoWidgetState extends State<EmptyTodoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmptyTodoModel());
  }
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Expanded(
                child: Text(
                  'Create todos by tapping the button below.',
                  textAlign: TextAlign.center,

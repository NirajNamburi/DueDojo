    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          backgroundColor: Colors.white,
          appBar: AppBar(
            backgroundColor: Color(0xFF14BCCD),
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.firstNameEntryController ??=
                                  ...
                                  validator: _model
                                      .firstNameEntryControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 16.0, 0.0, 0.0),
                                child: TextFormField(
                                  controller: _model.lastNameEntryController ??=
                                      TextEditingController(
                                  ...
                                  validator: _model
                                      .lastNameEntryControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      if ((_model.firstNameEntryController.text != '') &&
                          (_model.lastNameEntryController.text != '')) {
                        await editProfilePageUsersRecord.reference
                            .update(createUsersRecordData(
                          firstName: _model.firstNameEntryController.text,
                          lastName: _model.lastNameEntryController.text,
                        ));
                        context.safePop();
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Please enter a name. Cannot leave text field empty!',
                              style: TextStyle(
